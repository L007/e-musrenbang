...
<div class="page-wrapper container" >
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Tabel Potensi Industri</h1>
            </div>
            <!-- /.col-lg-12 -->
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <td><?php echo $post->idKelurahan; ?></td>
                                            ...
                                            <td><?php echo $post->nilaiJI; ?></td>
                                            <td><?php echo $post->nilaiLS; ?></td>
                                            ...
                                            <td>
                                              <div class="btn-group" role="group">
                                                <a href="?controller=industri&action=edit&idKelurahan=<?=$post->idKelurahan?>" name ="tedit" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span>Edit Score</a>
                                              </div>
                                    </tr>
                                    <?php } ?>
                                </tbody>
