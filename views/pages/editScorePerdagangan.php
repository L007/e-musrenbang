...
<div class="page-wrapper container" >
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Scoring Potensi Perdagangan</h1>
            </div>
            <!-- /.col-lg-12 -->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <?php foreach ($posts as $post) { ?>
                                   <input class="hidden" name="controller" value="perdagangan"></input>
                                ...
                                <div class="form-group">
                                    <label>nilai JU (Jumlah Usaha, Jasa, dan Perdagangan )</label>
                                    <select class="form-control" name="nilaiJU">
                                   ...
                                   <div class="form-group">
                                    <label>nilai LJ (Lembaga Jasa Keuangan)</label>
                                    <select class="form-control" name="nilaiLJ">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-4" >
                                                ...
                                                <a href="?controller=perdagangan&action=perdaganganDinas" name ="batal" class="btn btn-danger btn-block">Batal</a>
                                              </div>
