                                        ...
                                        <td><?php echo $post->idKelurahan; ?></td>
                                            ...
                                            <td>
                                              <div class="btn-group" role="group">
                                                <a href="?controller=perdagangan&action=edit&idKelurahan=<?=$post->idKelurahan?>" name ="tedit" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span>Edit Score</a>
                                              </div>
                                    </tr>
                                    <?php } ?>
                                </tbody>
